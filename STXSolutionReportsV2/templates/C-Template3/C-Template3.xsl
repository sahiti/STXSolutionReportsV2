							...
							<div style="background-color: #595959; color: #FFFFFF;">
								<table width="100%" border="0" cellspacing="5">
									<tr>
										...
										<td width="27%" bgcolor="#595959">Description</td>
										<td width="20%" bgcolor="#595959">Room Price</td>
									</tr>
								</table>
							</div>
							<table width="100%" border="0" cellspacing="5">
								<xsl:for-each select="Report/Rooms/Room">
									...
									<xsl:variable name="lastPackageName" />
									<xsl:for-each select="Packages/Package">
										<xsl:variable name="lastPackageGroupName" select="preceding-sibling::Package[1]/PackageGroupName"/>
										<xsl:choose>
											<xsl:when test="position()=1">
												<tr>
													<td width='14%' bgcolor='#BFBFBF'><xsl:value-of select="$room/RoomName" /></td>
													<td bgcolor='#BFBFBF' style='text-align: right' colspan='5'>
														<xsl:value-of select="RoomGroupTotalPrice" />
													</td>
												</tr>
												<tr>
													<td></td>
											...
											<xsl:when test="$lastPackageGroupName != PackageGroupName">
												<tr>
													<td></td>
													<td bgcolor='#BFBFBF' style='text-align: left' colspan='5'><xsl:value-of select="PackageGroupName" /></td>
												</tr>
											</xsl:when>
										</xsl:choose>
										<tr>
											<td><h4><xsl:value-of select="PackageName" /></h4><br/></td>
											...
											<td width='50%' style='text-align: center; font-size: 10px;'>
												<xsl:value-of select="PackageDescription" /></td>
										</tr>
									</xsl:for-each>
								</xsl:for-each>
							</table>
