				...
				<div style="margin-top: 20px;">
					<div class="border1" align="center">
						...
						<div style="padding: 20px; font-size: 14px;">
							...
							<table width="100%" border="0" cellspacing="5">
								<xsl:for-each select="Report/PackageGroups/PackageGroup">
									<xsl:variable name="lastPackageGroupName" select="preceding-sibling::PackageGroup[1]/PackageGroupName"/>
									<xsl:choose>
										<xsl:when test="position()=1">
											<tr>
												<td width='17%' bgcolor='#bfbfbf'>
													<xsl:value-of select="PackageGroupName" />
												</td>
												<td bgcolor='#bfbfbf' colspan='5'>
													<span style='float:right'>
														<xsl:value-of select="PackageGroupPrice" />
													</span>
												</td>
											</tr>
										</xsl:when>
									...
									<xsl:for-each select="Package">
										<tr>
											<td>
												<img width='85' height='85' alt='' src='{PackageIcon}'/>
											</td>
											<td width='15%'><p></p><h4><xsl:value-of select="PackageName" /></h4><p></p></td>
											<td style='font-size: 10px; text-align: center;' width='45%'>
											...
											<td width='20%'><xsl:value-of select="PackageTotal" /></td>
										</tr>
									</xsl:for-each>
								</xsl:for-each>
							</table>
