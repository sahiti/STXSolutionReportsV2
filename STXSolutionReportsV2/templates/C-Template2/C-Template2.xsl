			...
			<body style="font-size: 10px;" class="portraitPage">
				...
				<div style="margin-top: 20px;">
					<div class="border1" align="center">
						...
						<div style="padding-top: 20px; padding-bottom: 20px; padding-left: 10px; padding-right: 10px; font-size: 14px;">
							<div style="background-color: #595959; color: #FFFFFF;">
								<table width="100%" border="0" cellspacing="1">
									<tr>
										<td width="28%" bgcolor="#595959" style="color:#FFFFFF">Name/Info</td>
										<td width="48%" bgcolor="#595959" style="text-align: center; color:#FFFFFF">Description</td>
										<td width="8%" bgcolor="#595959" style="text-align: center; color:#FFFFFF">Unit Price</td>
										<td width="8%" bgcolor="#595959" style="text-align: center; color:#FFFFFF">QTY</td>
										<td width="8%" bgcolor="#595959" style="text-align: center; color:#FFFFFF">Price</td>
									</tr>
								</table>
							</div>
							<table width="100%" border="0" cellspacing="1">
									...
									<xsl:for-each select="Packages/Package">
										<xsl:if test="State = '' or State = 0">
											...
											<tr>
												...
												<td width='48%' style='font-size: 10px; text-align: center;'><xsl:value-of select="PackageDescription" /></td>
												<td width='8%' style='text-align: center;'><xsl:value-of select="PackagePrice" /></td>
												<td width='8%' style='text-align: center;'><xsl:value-of select="PackageQuantity" /></td>
												<td width='8%' style='text-align: center;'><xsl:value-of select="PackageTotal" /></td></tr>
											<xsl:variable name="lastPackageName" select="PackageGroupName" />
										</xsl:if> 
									</xsl:for-each>
								</xsl:for-each>
							</table>
