						...
						<div style="padding: 20px; font-size: 14px;">
							<div style="background-color: #595959; color: #FFFFFF;">
								<table width="100%" border="0" cellspacing="5">
									<tr>
										<td width="53%" bgcolor="#595959">Name/Info</td>
										<td width="47%" bgcolor="#595959">Description</td>
									</tr>
								</table>
							</div>
							<table width="100%" border="0" cellspacing="5">
									...
									<xsl:for-each select="Packages/Package">
										...
										<xsl:choose>
											<xsl:when test="position()=1">
												<tr><td bgcolor='#BFBFBF' colspan='6'><xsl:value-of select="$room/RoomName" /></td></tr>
												<tr><td><xsl:comment></xsl:comment></td>
												<td bgcolor='#BFBFBF' style='text-align: left' colspan='5'><xsl:value-of select="PackageGroupName" /></td></tr>
											</xsl:when>
										...
										<tr>
											<td><h4><xsl:value-of select="PackageName" /><br/><br/><img width='85' height='85' src='{PackageIcon}'/></h4><br/></td>
											<td width='33%' style='text-align: left'><img width='223' height='104' src='{PackageImagePath}' /></td>
											<td width='50%' style='text-align: center; font-size: 10px;'>
												<div style='border-bottom: 1px solid #000000;'>
													<xsl:value-of select="PackageDescription" />
												</div>
												<div><b>Comment : </b><xsl:value-of select="PackageComment" /></div>
											</td>
										</tr>
									</xsl:for-each>
								</xsl:for-each>
						...
						<table width="100%" border="0" cellspacing="5" style="padding-bottom: 20px; padding-left: 8px; padding-right: 8px;">
							<xsl:for-each select="Report/OtherCharges/Package">
								...
								<tr>
									...
									<td style='font-size: 10px; text-align: center;' width='75%'><xsl:value-of select="PackageDescription" /></td>
								</tr>
							</xsl:for-each>
						</table>
					</div>
